...
class Api:
    ...
    def __init__(self, address, user=USER, password=PASSWORD, use_ssl=USE_SSL, port=False,
        ...
        print('#-----------------------------------------------#')
        print('API IP - {}, USER - {}'.format(address, user))
        self.sock = None
        self.connection = None
        self.open_socket()
        self.login()
        print('Instance of Api created')
        self.is_alive()
    ...
    def open_socket(self):
        ...
        print('API socket connection opened.')
    ...
    def login(self):
        ...
        def check_reply(reply):
            if len(reply[0]) == 1 and reply[0][0] == '!done':
                ...
                print(f'Error in login process: {reply[0][1]}')
    ...
    def is_alive(self) -> bool:
        ...
        try:
            ...
            print("Router does not respond, closing socket.")
            self.close()
            return False

        print("Socket is open, router responds.")
        self.sock.settimeout(self.timeout)
        return True
